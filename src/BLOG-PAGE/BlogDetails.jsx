...
export default function BlogDetails() {
    ...
    useEffect(() => {
      fetch(`https://ecom.quick-ad.net/public/api/blogs/blog-details/${par.id}`)
  ...
  return (
    ...
    <hr />
              ...
              <div className="slider-container w-[100%]" data-aos="fade-right" data-aos-duration="2500">
                <Slider asNavFor={nav2} ref={sliderRef1}>
                  {[...Array(6)].map((_, index) => (
                    <div key={index}>
                      <h3>
                        <img src={b1.banner} alt="zoom-img" className="w-full h-[40rem] py-10 duration-200 cursor-zoom-in hover:scale-110" />
                      </h3>
                    </div>
                  ))}
                </Slider>
                ...
                <Slider asNavFor={nav1} ref={sliderRef2} slidesToShow={5} swipeToSlide={true} focusOnSelect={true} className="cursor-pointer">
                  {[...Array(6)].map((_, index) => (
                    <div key={index}>
                      <h3>
                        <img src={b1.banner} alt="zoom-img" className="px-2" />
                      </h3>
                    </div>
                  ))}
                </Slider>
      ...
      <h5 className='lg:text-2xl text-sm py-4 font-bold'>{b1.name}</h5>
