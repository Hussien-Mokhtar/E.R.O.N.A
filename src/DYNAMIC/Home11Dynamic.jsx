  ...
  return (
    <div className=" parentt2 w-auto container px-4 py-20 flex flex-col justify-center items-center ">
      <div className=" relative flex justify-center items-center  ">
        <img src={slider11.img} alt={slider11.img} className="h-[15rem]"/>
      </div>
      <div className="">
        ...
        <h4 className=" text-orange-500 font-bold flex justify-center items-center gap-4">
          {slider11.price1} <del className=" text-black">{slider11.price2}</del>
        </h4>
        <div className=" title2 absolute opacity-0 gap-1 lg:text-5xl text-6xl lg:ml-2 ml-16  flex justify-center items-center ">
